...
pub const START_LOGIN_CMD: i32 = 0;
pub const COMPLETE_LOGIN_CMD:i32 = 1;
pub const EXIT_CMD:i32 = 2;
pub const BANKING_CMD:i32 = 3;
pub const SHOW_BALANCE_CMD: i32 = 4;
pub const TRANSFER_CMD:i32 = 5;
pub const SEE_TURNOVER_CMD:i32 = 6;
